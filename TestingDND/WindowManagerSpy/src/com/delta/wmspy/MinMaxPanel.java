    ...
    public void populate() {
        try {
...

            {
                ...
                HashMap<AuxWindow, Object> map = (HashMap<AuxWindow, Object>)maxDSObject;
                for(AuxWindow win: map.keySet()) {
...

            {
                ...
                HashMap<AuxWindow, Object> map = (HashMap<AuxWindow, Object>)defaultDSObject;
                for(AuxWindow win: map.keySet()) {
                    lm.addElement("Window: " + (win == null?"NbMainWindow":win.getName()));
