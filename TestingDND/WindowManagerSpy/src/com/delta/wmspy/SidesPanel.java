...
//    private DefaultListModel lm = new DefaultListModel();
    ...
    public void populate() {
        try {
            ...
            HashMap<AuxWindow, HashMap<Mode, String>> sidesMap = (HashMap<AuxWindow, HashMap<Mode, String>>)smObject;
            ...
            HashMap<AuxWindow, HashMap<String, Mode>> sidesMap2 = (HashMap<AuxWindow, HashMap<String, Mode>>)smObject2;
            ...
            for(AuxWindow window: sidesMap.keySet()) {
            ...
            for(AuxWindow win: sidesMap2.keySet()) {
