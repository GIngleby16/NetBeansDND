...
public class WindowSystemSnapshot {
    ...
    private Map<AuxWindowStructureSnapshot.AuxWindowSnapshot, ModeStructureSnapshot.ModeSnapshot> maximizedMode;
...
//    private AuxWindowStructureSnapshot auxWindowSnapshot;
    ...
    /** */
    public void setMaximizedModeSnapshot(Map<AuxWindowSnapshot, ModeStructureSnapshot.ModeSnapshot> maximizedMode) {
        this.maximizedMode = maximizedMode;
    }
    
    /** Gets maximized mode. */
    public Map<AuxWindowSnapshot, ModeStructureSnapshot.ModeSnapshot> getMaximizedModeSnapshot() {
