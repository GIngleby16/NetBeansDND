...
public class ModeStructureSnapshot {
    // map of window to splitroot & sliding modes for that window, a null aux-window reference is used to represent the main-window
    private final Map<AuxWindowSnapshot, WindowModeStructureSnapshot> windowModeStructures;

    private final Set<ModeSnapshot> separateModeSnapshots;

    /** Creates a new instance of ModesModelSnapshot. */
    public ModeStructureSnapshot(Map<AuxWindowSnapshot, WindowModeStructureSnapshot> windowModeStructures, Set<ModeSnapshot> separateModeSnapshots) {
        this.windowModeStructures = windowModeStructures;
        this.separateModeSnapshots = separateModeSnapshots;
    }
    
    public Map<AuxWindowSnapshot, WindowModeStructureSnapshot> getWindowModeStructures() {
    ...
    public static class ModeSnapshot extends ElementSnapshot { 
        ...
        public boolean isVisibleInSplit() {
            ...
            if(mode.getKind() == Constants.MODE_KIND_EDITOR ) {
                ...
                AuxWindowImpl window = wm.getWindowForMode(mode);
    ...
    public String toString() {
        ...
        for(AuxWindowSnapshot window: windowModeStructures.keySet()) {
