...
final class WindowSystemAccessorImpl implements WindowSystemAccessor {
    ...
    private Map<AuxWindowAccessor, ModeAccessor> maximizedMode;
...
//    private AuxWindowStructureAccessor auxWindowStructureAccessor;
    ...
    /** */
    public void setMaximizedModeAccessor(Map<AuxWindowAccessor, ModeAccessor> maximizedMode) {
        this.maximizedMode = maximizedMode;
    }
    
    /** Gets maximized mode. */
    public Map<AuxWindowAccessor, ModeAccessor> getMaximizedModeAccessor() {
