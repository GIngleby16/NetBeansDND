...
public class ViewEvent {
    ...
    public String toString() {
        ...
        switch (type) {
            ...
            case View.CHANGE_AUX_WINDOW_ADDED : typeStr = "CHANGE_AUX_WINDOW_ADDED"; break; //NOI18N
            case View.CHANGE_AUX_WINDOW_REMOVED : typeStr = "CHANGE_AUX_WINDOW_REMOVED"; break; //NOI18N
        }
        buf.append(typeStr);
        buf.append("\nnewValue="); //NOI18N
        buf.append(newValue);
