...
public final class SlideOperationFactory {
    ...
    public static SlideOperation createSlideIn(AuxWindowImpl window, Component component, 
    ...
    public static SlideOperation createSlideOut(AuxWindowImpl window, Component component, 
        int orientation, boolean useEffect, boolean requestActivation) {
    ...
    public static SlideOperation createSlideIntoEdge(AuxWindowImpl window, Component component, 
    ...
    public static SlideOperation createSlideIntoDesktop(AuxWindowImpl window, Component component, 
    ...
    public static SlideOperation createSlideResize(AuxWindowImpl window, Component component, int orientation) {
    ...
    public static SlideOperation createSlideResize(AuxWindowImpl window, Component component, String side) {
