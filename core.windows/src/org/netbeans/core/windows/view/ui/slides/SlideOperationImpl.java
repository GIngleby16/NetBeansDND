...
class SlideOperationImpl implements SlideOperation, ChangeListener {
    ...
    SlideOperationImpl(AuxWindowImpl window, int type, Component component, int orientation, 
    ...
    SlideOperationImpl(AuxWindowImpl window, int type, Component component, String side, 
         SlidingFx effect, boolean requestsActivation) {
        this.window = window;
        this.type = type; 
