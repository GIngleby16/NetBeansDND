...
class ModeParser {
    ...
    */
    ...
    private final class PropertyHandler extends DefaultHandler {
        ...
        private void handleAuxWindowID (Attributes attrs) {
            modeConfig.auxWindowID = attrs.getValue("id"); // NOI18N
        }
        ...
        private void appendAuxWindow(ModeConfig mc, StringBuffer buff) {
            buff.append("    <aux-window id=\"").append(mc.auxWindowID).append("\"/>\n"); // NOI18N
        }
    }
