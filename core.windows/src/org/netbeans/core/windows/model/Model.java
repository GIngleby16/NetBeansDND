...
public interface Model {
    ...
    /** Sets active mode. */
    public void setActiveMode(AuxWindowImpl window, ModeImpl mode);
    ...
    /** Adds mode. */ 
    public void addMode(AuxWindowImpl window, ModeImpl mode, SplitConstraint[] constraints); // NEW

    /** Adds mode. */
    public void addModeToSide(AuxWindowImpl windw, ModeImpl mode, ModeImpl attachMode, String side);  // NEW
